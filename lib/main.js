...
(function () {
  const ScriptList = [
    // 'https://cdn.jsdelivr.net/npm/highlight.js@11/lib/common.min.js',
    // 'https://cdn.jsdelivr.net/npm/highlightjs-lean/dist/lean.min.js',
  ]
  ...
  const WASMList = [
    THIS_PATH + 'mathematics.js',
  ]
  WASMList.forEach((url) => {
    const script = document.createElement('script');
    script.src = url;
    script.type = 'module';
    document.body.appendChild(script);
