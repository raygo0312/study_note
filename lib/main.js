...
(function () {
  ...
  // 設定
  {
    let toggle_chat = document.createElement('label');
    let toggle_chat_checkbox = document.createElement('input');
    let toggle_chat_text = document.createTextNode('会話を表示');
    toggle_chat_checkbox.type = 'checkbox';
    toggle_chat_checkbox.checked = true;
    toggle_chat_checkbox.addEventListener('change', function () {
      let contents = document.querySelectorAll('.you, .me');
    ...
    document.getElementById('setting').appendChild(toggle_chat);
  }
